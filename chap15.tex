...
\index{перемешивание!в численных моделях!Меллора-Ямады схема}~\cite{Mellor:1982},
...
последовательных\index{последовательных приближений метод}~\cite{Bennett:1992}.
%
...
для параметризации мезомасштабных вихрей\index{мезомасштабный вихрь}~\cite{Gent:1990}. 
...
потокам\index{численные модели!совместные!подгонка по потокам}~\cite{Johns:1997}. 
...
\index{численные модели!совместные!подгонка по потокам}, так и без 
