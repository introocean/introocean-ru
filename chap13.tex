...
\textit{абиссалью}\index{абиссаль|textbf}, а циркуляцию,
...
Донная вода\index{донная вода!Североатлантическая} формируется 
...
литературы~\cite{Toggweiler:2008}. Причиной этого считается как
...
Следуя работе Вюнша~\cite{Wunsch:2002b}, будем считать глубинную циркуляцию
...
океане~\cite{Sabine:2004}, при этом большая часть растворенной углекислоты
...
\index{Глобальный конвейер}\index{перенос тепла!Глобальный конвейер}~\cite{Broecker:1987}. 
Суть его теории в том, что поверхностные течения
...
чтобы погрузиться до самого дна\index{донная вода!Североатлантическая} 
...
о глобальном конвейере был опубликован Ричардсоном~\cite{Richardson:2008}.
%
...
Донная вода из северной части Атлантического 
океана\index{донная вода!Североатлантическая} поднимается
...
образования Североатлантической донной воды в зимний период столь велико,
...
замечательной работе~\cite{Schmitz:1996}, подводящей итог всей его научной
...
оценки, выполненной Rintoul и Вюншем~\cite{Rintoul:1991}.
%
...
Процесс формирования донной воды\index{донная вода} находится под
влиянием поверхностной солёности и ветров в северной 
Атлантике~\cite{Toggweiler:2008}. Он также зависит от скорости 
...
Процесс формирования донной воды особо чувствителен к небольшим изменениям
...
циркуляцию величиной в~$14\Sv$~\cite{Rahmstorf:1995}. Если формирование донной
...
периода, благодаря сегодняшней более высокой концентрации~\COtwo{} в 
атмосфере~\cite{Weaver:2004}.
%
...
Формирование донной воды также особо чувствительно к небольшим изменениям
...
величиной~$2000\Twt$~\cite{Munk:1998}. 
...
донной воды в северной части Атлантического океана остановится? 
...
солнечную активность и интенсивность космического излучения~\cite{Alley:2000}.
%
...
ii) формировании Североатлантической донной воды, 
iii) объеме ледников,
...
после чего следовал более долгий период последовательного 
охлаждения~\cite{Dansgaard:1993}. Например, около $11\,500\yrs$~назад
температура в Гренландии повысилась примерно на~$\degCent{8}$ 
в течение $40\yrs$ за три этапа, каждый из которых 
продолжался~$5\yrs$~\cite{Alley:2000}. Такое внезапное потепление называется
...
частицы осаждались в центральной части океана~\cite{Bond:1992}. Такой 
...
(масштабы графиков не совпадают).~\cite{Zahn:1994}}
\label{fig:NAiceage}
\end{figure}
%
% \begin{figure}[t!]
...
среднее значение~\cite{Rahmstorf:1995}.
...
Дансгора-Эшгера~\cite{Stocker:2000}. Вероятный сценарий выглядит 
...
части~\cite{Martrat:2007}. Далее, примерно $1000\yrs$ спустя, возникает
...
на основе температурных данных из Антарктиды~\cite{Steig:2006}.
%
...
либо наоборот~\cite{Brauer:2008}. Помимо этого, источником скачкообразной
...
на~$2$--$\degCent{4}$ в течение~$1$--$3\yrs$~\cite{Steffensen:2008}. 
...
произошедшее почти в то же самое время, $12\,679\yrs$~назад~\cite{Brauer:2008}.
%
...
~\cite{Stommel:1958a}, \cite{Stommel:1958b}, \cite{Stommel:1960}. 
...
можно найти в работах Marotzke~\cite{Marotzke:2000}, 
Манка и Вюнша~\cite{Munk:1998}.
%
...
холодной воды~\cite{Munk:1998}. В этом случае глубинная циркуляция
...
и протекают они в различных местах~\cite{Marotzke:1999}. Конвекция 
...
на данном рисунке.~\cite{Stommel:1958a}}
...
при этом ослабевая до нуля у экватора (\cite[ур-е~7.3.15]{Stommel:1960}, 
см.\ также~\cite[\S~7.3]{Pedlosky:1996}). Потоки, возникающие под действием
...
системой срединно-океанических хребтов.~\cite{Tchernia:1980}}
\end{center}
...
процессы~\cite{Marotzke:1999}. Конвекция уменьшает потенциальную 
...
термоклине\index{термоклин!eddy diffusivity in}~\cite{Gargett:1992}.
%
...
диффузии, особенно вблизи боковых границ~\cite{Marotzke:1999}.
%
...
течение~\cite{Toggweiler:2008}, \cite{Garabato:2004}, \cite{Garabato:2007}. 
...
а вдоль хребтов~--- к полюсам~\cite{Hogg:2001}. Таким образом, общая картина
...
практическому применению~\cite{Tomczak:1999}.
%% "указания" ли?
%
...
действий~\cite{Friedman:1989}. Аналогично, водные массы формируются в различных
...
\emph{водной массы}\index{водная масса|textbf}~\cite{Tomczak:1999}:
\begin{quote}
...
станциях\index{гидрографические данные!сечение Гольфстрима} по обе стороны
...
\index{перемешивание!водных масс}. \cite[стр.~205]{Defant:1961}}
\label{fig:TSsketch}
\end{figure}
%
% \begin{figure}[t!]
...
\emph{уплотнение при смешении}\index{уплотнение при смешении|textbf} 
...
глубины (табл.~\ref{tbl:13.1}): Антарктическая донная 
вода\index{донная вода!Антарктическая} (Antarctic Bottom Water, AAB), 
...
Воспользуемся данными поперечного разреза в поле солёности, чтобы проследить
...
которой (M) превосходит плотность каждого из типов. \cite[стр.~137]{Tolmazin:1985}}
...
Антарктическая вода      & Антарктическая промежуточная вода  & AIW   & 3.3 & 34.15 \\
                         & Антарктическая донная вода      & ABW   & 0.4 & 34.67 \\
Североатлантическая вода & Североатлантическая глубинная вода & NADW  & 4.0 & 35.00 \\
                         & Североатлантическая донная вода & NABW  & 2.5 & 34.90 \\
Вода термоклина          & Subtropical Lower Water           & \textsc{u}     & 18.0         & 35.94     \\ [0.5ex]
\hline
\end{tabular} \\ [0.5ex]
\footnotesize{\ From~\cite[table~82]{Defant:1961}} \rule{0ex}{1.5ex} \hfill
\
\end{table}
%
...
воды), AAB (Антарктической донной воды\index{донная вода!Антарктическая}), 
...
Начнем с меридионального разреза в поле солёности в западных котловинах 
...
Еще ниже находится наиболее плотная Антарктическая донная вода%
\index{водная масса!Антарктическая донная вода}. 
...
по~\latlon{50}{S} соответственно. Верхнее ядро образовано Антарктической 
промежуточной, а нижнее~--- Североатлантической глубинными водными массами%
\index{Североатлантическая глубинная водная масса}. Стрелками показано 
предполагаемое направление переносов в ядрах. Антарктическая донная 
вода\index{донная вода!Антарктическая} заполняет наиболее глубокие
слои с~\latlon{50}{S} по~\latlon{30}{N}. PF и~SAF~--- Полярный и
...
в глубинных и донных слоях над абиссальной зоной\index{абиссаль} 
может быть объяснено комбинацией медленных потоков
...
Срединно-Атлантического хребта~\cite{Church:2007}. 
...
\index{Антарктическое циркумполярное течение}, полученная
...
приблизительно~$50\km$ вдоль линии, пересекающей пролив~\cite{Whitworth:1985}. 
...
\index{Циркумполярная глубинная вода!состав}, представляющей собой смесь
...
а затем распределяется обратно в каждый океан~\cite{Garabato:2007}.
%
...
$8$--$10\Sv$ донной воды~\cite{Orsi:1999}. 
...
достигающие максимальной скорости под~\latlon{50}{S}, приводят воду
...
циркуляцию~\cite{Toggweiler:2008}.
%
...
преобладающей силой является сопротивление формы\index{сопротивление!формы}, 
которое возникает при пересечении течением
подводных хребтов, особенно в проливе Дрейка~\cite{Munk:1951}. 
Примером сопротивления формы также
...
океана\index{донная вода!Североатлантическая} в северное полушарие
