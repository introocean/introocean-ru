...
\index{перемешивание!в термоклине} на больших площадях. Подобное
upward mixing\index{mixing!of deep waters} и служит движущей силой
...
кислород и т.п., но перенос таких растворенных веществ может отличаться
...
В океане содержится $40\,000~\GtC$ (растворенного, particulate, 
...
Еще больший объем углерода входит в состав carbonate rocks
such as limestone, раковин морских животных, кораллов и т.п. 
...
Например, Стефенсен обнаружил, что $11\,704$, $12\,896$ и~$14\,694$~лет
...
\begin{align}
  ...
  V &= R \tan \varphi \,W_0,\label{eq:13.2}
\end{align}
...
измерения придонного давления, а также температуры и солёности 
throughout the water column at 15 locations along \latlon{24}{N} 
