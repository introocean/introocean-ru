...
радиусом
$$
R_e=6\,378.1349\mbox{~км \cite{West:1982}},
$$ 
...
Международной гидрографической организацией~\cite{IHB:1953}. Моря, которые считаются 
...
согласно работам~\cite{Sverdrup:1942}, \cite{Shepard:1963}
...
медленно движущейся бумажной ленте~\cite[стр.~124]{Dietrich:1980}.}
\label{fig:Sonar}
\end{figure}
%
% \begin{figure}[t!]
...
между измерениями эхолотов~\cite{Smith:1994}. 
...
и средней погрешностью по глубине, равной~$\pm 100\m$~\cite{Smith:1997}.
\end{subparagraph}
% 
...
работы~\cite{Smith:1997}, в которой результаты эхолотирования
...
давления~\cite{MacKenzie:1981}, \cite[стр.~33]{Munk:1995}:
\begin{equation}
...
и~$Z$~--- глубина в метрах. Точность этой формулы 
примерно~$0.1\mps$~\cite{Dushaw:1993}. 
Существуют и другие популярные формулы скорости звука,
например, формула Вильсона~\cite{Wilson:1960}, которую широко использовал
...
оси подводного звукового канала~\cite{Munk:1995}.}
\label{fig:raypaths}
\end{figure}
%
% \begin{figure}[t!]
...
\remark{Строго говоря, в качестве параметра~$k$ соотношения~\ref{eq:3.3} 
применимо не само значение в децибелах, рассчитанное по указанному определению, 
а его абсолютная величина, преобразованная из десятичного логарифма 
в натуральный.}%
%
...
побережье Тихого океана~\cite{Munk:1994}.
%
