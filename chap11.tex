...
с широтой~\cite{Sverdrup:1947}. Генри Стоммел установил, что асимметрия
океанских круговоротов также определяется вариацией силы Кориолиса 
с широтой~\cite{Stommel:1948}. Наконец, Уолтер Манк учёл влияние 
eddy viscosity и вычислил циркуляцию в верхних слоях Тихого 
океана~\cite{Munk:1950}. Совместные достижения этих трех океанологов 
...
среднегодового ветрового 
напряжения\index{ветровое напряжение!среднегодовое}.~\cite{Reid:1948}}
...
глубины~$1\km$. Отметим разницу в масштабе~$M_y$ и~$M_x$.~\cite{Reid:1948}}
...
При выборе иной глубины согласование результатов оставляет желать 
лучшего~\cite{Leetmaa:1981}.
%
...
Свердрупа, проведенный Вюншем~\cite[\S~2.2.3]{Wunsch:1996}, привел его к выводу,
...
количественных характеристик реальных полей океанских течений.~\cite{Wunsch:1996}
\end{quote}
%
...
Шаг изолиний~--- $10\Sv$.~\cite[стр.~46]{Tomczak:1994}}
...
важность соотношения Свердрупа трудно переоценить.~\cite{Wunsch:1996}
\end{quote}
Отметим, что разрыв между теорией и практикой сокращается. Измерения среднего
напряжения в экваториальной зоне Тихого океана~\cite{Yu:1999} 
...
нам потребуется ввести понятия линий и функций 
тока~\cite[стр.~51, 66]{Kundu:1990}.
%
...
двумерного установившегося потока.~\cite[стр.~68]{Kundu:1990}}
...
уравнениями, что и Свердруп~\cite{Stommel:1948}: (\ref{eq:11.1}), (\ref{eq:11.2}) 
и~(\ref{eq:11.3}), введя дополнительно в уравнение~(\ref{eq:11.3}) понятие
придонного трения, пропорционального скорости:
\begin{subequations}
\begin{alignat}{2}
\left(A_z \frac{\partial{u}}{\partial{z}}\right)_0 &= -T_x =-F\cos(\pi \,y/b)& \qquad \left(A_z \frac{\partial{u}}{\partial{z}}\right)_{-D} &= -R\,u, \\
\left(A_z \frac{\partial{v}}{\partial{z}}\right)_0 &= -T_y =0 & \qquad \left(A_z \frac{\partial{v}}{\partial{z}}\right)_{-D} &= -R\,v,
\end{alignat}
\end{subequations}
%%% в оригинале индекс D, заменен на -D для единообразия (см. bug #213)
где~$F$ и~$R$~--- константы.
%
...
течения иной структуры. В работе Педлоски~\cite[гл.~5]{Pedlosky:1987} приводятся
...
боковой вихревой вязкости~\cite{Rossby:1936}, У.~Манком была сформулирована теория
циркуляции в масштабе океана~\cite{Munk:1950}.
...
для прямоугольной области, вычисленная Манком в работе~\cite{Munk:1950} на основе
...
\textbf{Справа внизу:} меридиональная составляющая переноса массы.~\cite{Munk:1950}}
...
региональной океанографии, таким как~\cite{Tomczak:1994}.
%
...
в~$10^6\text{~м}^3/\text{с}$.~\cite[рис.~187]{Sverdrup:1942}}
\label{fig:NAtlcur1}
\end{figure}
%
% \begin{figure}[t!]
...
в~$10^6\cubmps$. 
Теплые течения обозначены сплошными линиями, а холодные --- 
прерывистыми.~\cite[стр.~542]{Dietrich:1980}}
\label{fig:NATLcur1}
\end{figure}
%
% \begin{figure}[t!]
...
вихря составляет~$80\km$~\cite{Richardson:1993}.
%
...
под~\latlon{37}{N} \latlon{71}{W}.~\cite{Richardson:1981}}
\label{fig:drifters}
\end{figure}
%
% \begin{figure}[t!]
...
примерно~$\degrees{1}$.~\cite{Ring Group:1981}}
...
Согласовать теорию с данными наблюдений удалось Ниилеру~\cite{Niiler:1987}.
...
спутнике~NOAA-5, за октябрь-ноябрь~1978~г.~\cite[стр.~91]{Tolmazin:1985}.}
\label{fig:ringsmap}
\end{figure}
%
% \begin{figure}[t!]
...
Подробнее эта тема освещается в работе~\cite{Starr:1968}.
%
