...
потребуется $4\,000\Joules$~энергии.
%
...
изменчивость температуры воды еще более низка (рис.~6.3, нижняя часть).
%
...
\begin{enumerate}
\item
Высота Солнца над горизонтом, которая зависит от широты, времени года и дня.
Не следует забывать, что ночью инсоляция отсутствует!
%
% \vitem
...
\begin{enumerate}
   ...
   \item поглощения молекулами газов солнечного излучения в определенных 
         диапазонах (рис.~5.2); при этом играет роль концентрация различных
...
Величина среднегодовой инсоляции (рис.~5.3) находится в диапазоне
%
...
представлен на рис.~5.4. Он показывает, что в некоторых диапазонах длин
волн, называемых окнами, атмосфера практически прозрачна.
%
...
дождемеров~(рис.~5.5). Также количество осадков может быть рассчитано на
основе реанализа погодных данных при помощи численных моделей атмосферной
циркуляции (Schubert, Rood, and Pfaendtner, 1993), либо путем объединения
судовых и спутниковых наблюдений с результатами численных моделей прогноза
погоды (Xie and Arkin, 1997).
%
...
предложена в работе DaSilva, Young, and Levitus (1995) и показана на рис.~5.7.
%
...
поток тепла должен составлять~$16\wpsqm$ (рис.~5.7).
%
...
Эти значения показывают вклад каждого из слагаемых (рис.~5.6). Отметим, что
на верхней границе атмосферы величина инсоляции уравновешивает исходящую
инфракрасную радиацию. В то же время, на поверхности Земли поток скрытого
тепла и суммарная инфракрасная радиация сопоставимы с инсоляцией, а поток
явного тепла невелик.
%
...
Зональные средние значения слагаемых теплового баланса океана (рис.~5.7)
...
на рис.~5.7 не равна нулю. Аreal-weighted интеграл кривой суммарного потока
...
суммарных потоков тепла (рис.~5.7). Потоки, вычисленные с учетом ограничений,
показывают, что приток тепла в океан в тропиках компенсируется оттоком тепла
...
достигающего морской поверхности (рис.~5.8, верх); нагрев за счет этого 
излучения везде положителен. Суммарный поток инфракрасного излучения 
...
Потоки скрытого тепла (рис.~5.9) в области пассатов определяются испарением
...
фронтов. Потоки явного тепла (рис.~5.10, верх) находятся под преобладающим
влиянием холодного воздуха, стекающего с континентов. Суммарный приток 
тепла (рис.~5.10, низ) максимален в области экватора, а суммарная его 
потеря~--- downwind on Asia and North America.
%
...
тепла (рис.~5.7). Наконец, мы вычисляем перенос при помощи интегрирования
среднего потока по зоне в меридиональном направлении, подобно тому, как это
делается для верхней границы атмосферы.
%
...
океана в общий перенос тепла как остаток (рис.~5.11).
%
...
которых показаны на рис.~5.11, в целом дают согласующиеся между собой 
результаты; показанные на рисунке планки погрешностей реалистичны.
...
земной поверхности на~$\pm \degCent{0.4}$ (рис.~5.12). В дополнение, по 
показаниям батитермографов и судовых термометров на протяжении последнего 
столетия были обнаружены White and Cayan (1998) небольшие периодические 
